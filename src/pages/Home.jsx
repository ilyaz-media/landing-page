    ...
    <div
      ...
      <div  data-aos='fade-up' className="  flex flex-col justify-center gap-5 text-gray-800 py-10  ">
        ...
        <div className="flex gap-2">
          ...
          <a
            href="#portofolio"
            className="px-5 py-3 flex bg-white items-center rounded-lg shadow-lg gap-2 text-sm lg:text-base ">
        ...
        <div className=" flex flex-col mt-10 lg:flex-row justify-center  gap-3  text-sm ">
          <div className="   flex gap-2">
            <div className="left p-5 rounded-full bg-white">
              <ShieldCheck />
            </div>
            <div className="right ">
      ...
      <div className=" mockup  relative p-5 lg:p-5"  data-aos='fade-down'>
        <svg
          ...
          className="absolute z-[-1] bottom-[10%] left-0 lg:bottom-[10%]  h-full w-full lg:left-[4%] ">
          <path
            fill="#22d3ee"
            d="M38.8,-61.3C47.8,-54.5,51,-39.6,60.1,-25.7C69.1,-11.8,83.9,1.2,83.6,12.9C83.3,24.6,67.8,34.9,53.7,40.7C39.6,46.4,27,47.6,14.8,51.9C2.6,56.2,-9.1,63.7,-21.9,64.5C-34.7,65.4,-48.6,59.8,-53.6,49.1C-58.7,38.5,-55,22.9,-57.3,8.1C-59.6,-6.7,-68,-20.8,-67.6,-34.7C-67.2,-48.6,-58,-62.3,-45.3,-67.4C-32.6,-72.5,-16.3,-69.1,-0.7,-68C14.9,-66.8,29.7,-68.1,38.8,-61.3Z"
            transform="translate(100 100)"
          />
        </svg>
        <img src={mockup} alt="" className="lg:ml-20" />
      </div>
    </div>
  );
}
